...
const teamMembers = [
 ...
 function getSummary() {
     //console.log(`-The last Scribe was: ${getCurrentScribe()}, \n-The next Scribe should be: ${nextScribe}, \n-The last update was: ${lastUpdate}`);
 ...
 function runUpdate() {
     ...
     //console.log(`-The new Scribe is: ${getCurrentScribe()}`);
 }
